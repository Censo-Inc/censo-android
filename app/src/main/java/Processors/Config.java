...
public class Config {
    ...
    public static void initializeFaceTecSDKFromAutogeneratedConfig(Context context, String deviceKeyId, FaceTecSDK.InitializeCallback callback) {
        FaceTecSDK.initializeInDevelopmentMode(context, deviceKeyId, PublicFaceScanEncryptionKey, callback);
    }
