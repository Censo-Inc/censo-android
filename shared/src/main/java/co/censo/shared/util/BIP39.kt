...
object BIP39 {
    ...
    private fun WordListLanguage.toId(): Byte {
        return when (this) {
            WordListLanguage.English -> 1
        }
    }

    private fun fromWordListId(id: Byte): WordListLanguage {
        return when (id.toInt()) {
            1 -> WordListLanguage.English
    ...
    fun validateSeedPhrase(phrase: String) = validateSeedPhrase(splitToWords(phrase))
    ...
    fun validateSeedPhrase(words: List<String>, language: WordListLanguage = WordListLanguage.English): BIP39InvalidReason? {
    ...
    fun phraseToBinaryData(phrase: String, language: WordListLanguage = WordListLanguage.English): ByteArray {
        val words = splitToWords(phrase)
        val wordlist = wordlists[language]!!
    ...
    fun binaryDataToWords(binaryData: ByteArray, language: WordListLanguage? = null): List<String> {
        ...
        val wordlist = language?.let {
            ...
            wordlists[fromWordListId(binaryData[0])]!!
        }
