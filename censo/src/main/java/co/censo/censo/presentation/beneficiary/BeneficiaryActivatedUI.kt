...
fun BeneficiaryActivatedUI(
    ...
    Column(
        ...
        val messageText = stringResource(co.censo.censo.R.string.beneficiary_activated_message)

        Text(
            modifier = Modifier.padding(horizontal = screenWidth * 0.15f),
            text = messageText,
            fontSize = 26.sp,
...
@Composable
fun LargeBeneficiaryActivatedUIPreview() {
    Box(
        Modifier
            .fillMaxSize()
...
@Composable
fun NormalBeneficiaryActivatedUIPreview() {
    Box(
        Modifier
            .fillMaxSize()
            .background(Color.White)
...
@Composable
fun SmallBeneficiaryActivatedUIPreview() {
    Box(
        Modifier
            .fillMaxSize()
            .background(Color.White)
