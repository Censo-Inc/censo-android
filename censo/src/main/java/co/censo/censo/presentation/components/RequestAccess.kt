        ...
        Column(
            ...
            MessageText(
                ...
                message = stringResource(
                    co.censo.censo.R.string.request_access_message,
                    approverName
                ),
                textAlign = TextAlign.Start
            )

            //TODO: Need approver UI here and offer the owner the choice of their user
        }
...
@Preview
@Composable
fun RequestAccessPreview() {
    Box(
        modifier = Modifier
            .fillMaxSize()
            .background(Color.White)
    ) {
        RequestAccess("Buddy", onApproverSelected = {}) { }
    }
}